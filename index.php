					...
					<div id="portfolio" class="portfolio grid-container clearfix">
						...
						<article class="portfolio-item pf-wordpress">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/wp-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Kalypso - motyw WordPress"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item pf-wordpress">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/abctax-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Abctax - motyw WordPress"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item pf-static">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/viperwing-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Viperwing - strona statyczna"><i class="icon-line-plus"></i></a>
									<a href="img/full/viperwing-2.jpg" data-lightbox="gallery-item" title="Viperwing - strona statyczna"></a>
						...
						<article class="portfolio-item pf-static">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/zielone-szczepankowo-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Zielone Szczepankowo - strona statyczna"><i class="icon-line-plus"></i></a>
									<a href="img/full/zielone-szczepankowo-2.jpg" data-lightbox="gallery-item" title="Zielone Szczepankowo - strona statyczna"></a>
						...
						<article class="portfolio-item pf-static">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/asimpex-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Asimpexs - strona statyczna"><i class="icon-line-plus"></i></a>
									<a href="img/full/asimpex-2.jpg" data-lightbox="gallery-item" title="Asimpex - strona statyczna"></a>
						...
						<article class="portfolio-item pf-graphics pf-shop">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/solaris-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Solaris - sklep internetowy"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item pf-graphics pf-shop">
							<div class="portfolio-image">
								...
								<div class="portfolio-overlay" data-lightbox="gallery">
									<a href="img/full/allto-1.jpg" class="left-icon" data-lightbox="gallery-item" title="Allto - sklep internetowy"><i class="icon-line-plus"></i></a>
